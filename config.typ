...
#let template = tufted.tufted-web.with(
  ...
  header-elements: (
    [AOBlog | $r = a (1 - sin theta)$],
  ),
  /// 自定义页脚元素列表 (content 数组)，显示在页面底部。
  footer-elements: (
    "© 2026 AppOfficer",
    [Made with ♥ by #link("https://github.com/Yousa-Mirage/Tufted-Blog-Template")[Tufted-Blog-Template]],
  ),
)
